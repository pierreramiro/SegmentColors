...
if __name__ == "__main__":
    picture1 = cv2.imread('projects/Hidrocarburos/pictures/DJI_0608_T.JPG')##imagen de referencia
    picture2 = cv2.imread('projects/Hidrocarburos/pictures/DJI_0623_T.JPG')
    picture2 = cv2.imread('projects/Hidrocarburos/pictures/DJI_0632_T.JPG')
    picture2 = cv2.imread('projects/Hidrocarburos/pictures/DJI_0614_T.JPG')
    #picture2 = cv2.imread('projects/Hidrocarburos/pictures/DJI_0620_T.JPG')
    ...
    xLen=3#(picture1.shape)[0] ##Colocar la distancia georeferenciada que debe tener el plano
    yLen=3#(picture1.shape)[1] ##Colocar la distancia georeferenciada que debe tener el plano
    plt.subplot(2, 2, 1)
    ...
    xLen=3#(picture2.shape)[0] ##Colocar la distancia georeferenciada que debe tener el plano
    yLen=3#(picture2.shape)[1] ##Colocar la distancia georeferenciada que debe tener el plano
    plt.subplot(2, 2, 2)
